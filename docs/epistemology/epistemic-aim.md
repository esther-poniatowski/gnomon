...
The epistemic aim specifies the cognitive achievement that an answer must deliver. The aim is the first dimension of the [task that fixes the kind of knowledge an answer carries](epistemic-task.md). The aim also selects the interrogative word of the research question.
