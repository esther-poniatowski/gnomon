...
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| Scope          | - the claim ranges over the [*reference class* of the system](target-system.md) $S$, restricted by the [*domain*](domain.md) $D$, with the *quantification* each declared [source of variation across instances](phenomenon.md) carries;<br>- laws stated over derived units hold across $D$ the domain, rather than case by case                                                                     | target population [lundberg2021]                                                         |
| Grain          | - the answer fixes the [*explanandum variable*](phenomenon.md) at the stated grain: its *value set*, the indices its *signature* retains, and the *expression* or *condition* that fixes it; <br>- the explanandum variable stays definable over the units that the answer uses                                                                                                                                      | proportionality [woodward2010]                                                           |
| Contrast       | the explanans favors the [*fact over each foil*](contrast.md): each foil the question names is one that some factor *separates*, by citing what is present in the case of the fact and absent in the case of that foil                                                                                                                                                                                                                            | favoring the topic [vanfraassen1980]; difference condition [lipton2004]                  |
| Relation       | the link between the explanans and the explanandum has the [*requested kind*](requested-relation.md), and each factor reaches what it *produces* through the laws and relations it names (e.g. a dependence invariant under interventions for a causal relation, mutual manipulability for a constitutive relation, a proof for a mathematical relation)                                                                                                           | [woodward2003]; [craver2007]                                                             |
| Individuation  | - every [constituent that the answer treats as a bearer](answer-form.md#^perspective) either *references* a constituent the system declares or carries its own *expression*; <br>- the re-individuated model agrees with the declared one, on the interventions that both represent for a causal, mechanistic or constitutive relation, and on the derivations for a formal target | decomposition as a revisable strategy [bechtel1993]; causal consistency [rubenstein2017] |
| Admissible explanans | every *variable* and *parameter* the answer declares either *references* one the system declares or carries its own *expression*, and lies within the [*admissible explanans*](admissible-explanans.md); every aggregate has unambiguous intervention effects                                                                                                                                                                                                            | [spirtes2004]                                                                            |
...
| Product        | the answer delivers the [product of the *epistemic aim*](epistemic-aim.md), the inquiry fixes everything [that aim requires](epistemic-aim.md#^required-by-aim), and the answer holds every virtue the question marks [constitutive](epistemic-pragmatic-virtues.md#^virtue-standing)                                                         | intelligibility criterion [deregt2005]                                                   |
...
| Law warrant            | each law the answer states holds on the [*warrant*](target-system.md#^law-warrant) it claims: one marked derived is derivable from the laws it rests on, one marked fitted or measured names the data it was fitted to or measured from | check each law of the answer against what its warrant rests on; a conclusion inherits the weakest warrant among the laws it uses | [nagel1961] |
...
| Selection              | a claim about selected members extends to the full class only after a check for selection bias, which the class invites exactly where its [membership is conditioned on an outcome](target-system.md#^selection-on-outcome)                           | when a criterion depends on an outcome, test the association in the full class                                                      | [hernan2004]                                               |
...
> Appraisal adds no test of its own: its criteria are the virtues the question marks [preferred](epistemic-pragmatic-virtues.md#^virtue-standing), and each virtue already carries its operational question. What appraisal adds is a record, filled for one answer at a time.
...
- **Only the virtues marked preferred are appraised.** A virtue the question did not select does not bear on the answer, since the inquiry did not commit to it. A virtue it marks [constitutive](epistemic-pragmatic-virtues.md#^virtue-standing) is settled by the product test, where failing it makes the answer inadmissible, so appraisal does not rank on it a second time.
...
| Tests: admissibility | always | per criterion of the admissibility table, a verdict — pending · pass · fail · not-applicable — with the evidence that settles it | contrast: pass, by producing the asynchronous state in a simulation; admissible explanans: not-applicable, since the question bounded the answer to no variables | [admissibility](#^conditions-satisfaction) |
