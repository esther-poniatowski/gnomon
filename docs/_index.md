...
| [References and methods](methods-reasoning/_index.md) | The formal reasoning domains and the reasoning principles the design draws on, each stated on its own terms before any application. |
