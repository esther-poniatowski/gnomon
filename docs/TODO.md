...
| --- | --- | --- |
| Extract common design principles and make the criteria coherent. | Done. Tier 1 and Tier 2 criteria now carry the common principles and constraints that cut across themes. | [Tier 1 index](vendor/gnomon/docs/design/1-framework/_index), [Tier 2 constraints](vendor/gnomon/docs/design/2-architecture/constraints) |
