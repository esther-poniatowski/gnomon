...
- [Arguments and reasoning](vendor/gnomon/docs/design/3-aspect-specific/arguments-reasoning) — criteria that assemblies must satisfy to count as good arguments (stub; traces to [t1-intelligibility](../1-framework/reasoning-integrity#^t1-justification-levels) and [promotion of assembly-local records](vendor/gnomon/docs/design/2-architecture/reasoning-structure#^t2-assembly-record-promotion)).
