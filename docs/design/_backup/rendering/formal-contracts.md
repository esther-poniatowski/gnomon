...
- **Scope** → the note must be organized around one **local inferential objective** (see [atomicity criterion](../../../references-methods/decision-rules.md#^atomicity-criterion))
