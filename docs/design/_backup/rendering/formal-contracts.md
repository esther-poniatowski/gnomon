...
- **Scope** → the note must be organized around one **local inferential objective** (see [atomicity criterion](../../../methods-reasoning/decision-rules.md#^atomicity-criterion))
