...
The [audit](post-draft-audits.md) pass must verify that the note's declared type matches its actual content — see [audit enforcement by note type](post-draft-audits.md#audit-enforcement-by-note-type).
