...
The asymmetry preserves [t1-modularity](../1-framework/modular-content-organization#^t1-reuse) and [t2-single-source-of-truth](vendor/gnomon/docs/design/2-architecture/constraints#^t2-single-source-of-truth).
