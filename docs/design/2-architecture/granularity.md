...
>
> Theme-local criterion bearing on this file: [object-kind set smallness](object-kinds.md#^t2-ontology-small). Framework-level criteria bearing on this theme: [activity coverage](../1-framework/expressive-depth.md#^t1-activity-coverage) and [t1-partial-formalization](../1-framework/expressive-depth.md#^t1-partial-formalization). See also tension [X2](../1-framework/_tensions.md#^t2-x2).
...
The fields-on-canonical-objects alternative is closed by [t2-reasoning-annotation-attachment](reasoning-structure.md#^t2-reasoning-annotation-attachment): strategic and explanatory justification cannot live on canonical objects under the placement rule, so reasoning records cannot be canonical-object annotations.

Bearing criteria: [t1-intelligibility](../1-framework/reasoning-integrity.md#^t1-justification-levels), [non-redundancy](../1-framework/modular-content-organization.md#^t1-non-redundancy), [t1-feasibility](../1-framework/cost-ergonomics.md#^t1-system-scale), [revision accountability](../1-framework/research-activities-workflows.md#^t1-revision-accountability).
...
Bearing criteria: [object-kind set smallness](object-kinds.md#^t2-ontology-small), [t1-reasoning-types-coverage](../1-framework/expressive-depth.md#^t1-reasoning-types-coverage), [t1-activity-coverage](../1-framework/expressive-depth.md#^t1-activity-coverage).
...
- `mandatory_field_set` selects, from the field set per locus × content-kind cell fixed by [t2-reasoning-annotation-fields](reasoning-structure.md#^t2-reasoning-annotation-fields), which optional fields become mandatory at this profile;
- `validator_set` selects, from the validators declared by [t2-validator-placement](validation-views.md#^t2-validator-placement), which must pass for a record to satisfy the profile;
...
Bearing criteria: [t1-partial-formalization](../1-framework/expressive-depth.md#^t1-partial-formalization), [t1-feasibility](../1-framework/cost-ergonomics.md#^t1-system-scale), tension [X2](../1-framework/_tensions.md#^t2-x2).
