...
aliases:
  - Nonreciprocal active-matter test description
---
# Phase exploration in nonreciprocal active matter

## Research problem

Nonreciprocal active matter poses an exploratory problem because local interactions can be specified before the resulting collective phases are known. Which macroscopic phases occur as the control parameters vary? Which phases persist across finite spatial dimensions and in the thermodynamic limit?
...
The case does not assume a phase catalogue or a privileged order parameter.

## Scientific basis

Local nonreciprocal interactions can generate collective phases without equilibrium counterparts ([fruchart2021](https://www.nature.com/articles/s41586-021-03375-9)).
