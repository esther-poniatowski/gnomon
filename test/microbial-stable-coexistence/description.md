...
---
# Stable coexistence in microbial communities
...
- represent a class of possible ecological systems whose laws close each model;
- describe coexistence as a capacity with separate feasibility and stability conditions;
- distinguish modal knowledge as the epistemic aim from necessity as the strength of the requested claim;
- express necessary and sufficient mathematical constraints without presupposing one interaction mechanism;
- quantify separately over resource supplies and over the two model variants without recoding either range as an optional virtue.

## Scope boundary

The case does not assume that pairwise competition or one resource geometry supplies the answer. Empirical parameter estimates may constrain the model class without replacing the theoretical question.
